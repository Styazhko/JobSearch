    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to='company_images', verbose_name='Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(upload_to='company_images', verbose_name='Изображение')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='vacancies', to='search.company', verbose_name='Компания')),
                ('specialty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='vacancies', to='search.specialty', verbose_name='Специализация')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vacancy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='search.vacancy')),
            ],
            options={
